...
-- === Botão de Abrir/Fechar (somente o botão, NÃO cria ScreenGui) ===
-- Cole este bloco logo após a criação de aa.ScreenGui

do
    local parent = aa and aa.ScreenGui and aa.ScreenGui:FindFirstChild("Window") or (aa and aa.ScreenGui) or game:GetService("CoreGui")

    local OpenButton = Instance.new("ImageButton")
    OpenButton.Name = "OpenButton"
    OpenButton.Parent = parent
    OpenButton.AnchorPoint = Vector2.new(1, 0)
    OpenButton.Position = UDim2.new(1, -16, 0, 8)
    OpenButton.Size = UDim2.new(0, 42, 0, 42)
    OpenButton.BackgroundTransparency = 1
    OpenButton.Image = "rbxassetid://99764942615873"
    OpenButton.ImageTransparency = 0
    OpenButton.ZIndex = 99999

    local uic = Instance.new("UICorner", OpenButton)
    ...
    local function toggleUI()
        ...
        if parent and parent:IsA("Instance") then
            for _, child in ipairs(parent:GetChildren()) do
                if child:IsA("GuiObject") and child ~= OpenButton then
        ...
        if isOpen then
            ...
            OpenButton.Image = "rbxassetid://120997033468887"
        end
    end
