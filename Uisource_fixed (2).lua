...
function NatUI:Window(Title, Description, Icon)
    ...
    NatUI.uiLibrary = uiLibrary -- Usando nome descritivo em vez de índice numérico
    ...
    NatUI.containerTab = containerTab
    ...
    NatUI.scrollingFrame = scrollingFrame
    ...
    NatUI.holderUIAspectRatioConstraint = holderUIAspectRatioConstraint

    -- UICorner for Holder
    local holderUICorner = Instance.new("UICorner")
    holderUICorner.Parent = holder
    NatUI.holderUICorner = holderUICorner
end
...
function NatUI:AddTab(Title, Desc, Icon)
    ...
    list.Parent = NatUI.scrollingFrame -- Parent to ScrollingFrame
    NatUI.list = list
    ...
    NatUI.uiListLayout = uiListLayout
    ...
    buttonFrame.Parent = NatUI.scrollingFrame
    NatUI.buttonFrame = buttonFrame
    ...
    NatUI.buttonDontchange = buttonDontchange
    ...
    NatUI.buttonUIListLayout = buttonUIListLayout
    ...
    NatUI.oneTextButton = oneTextButton
    ...
    line.Parent = NatUI.containerTab
    NatUI.line = line
    ...
    containerElement.Parent = NatUI.holder
    NatUI.containerElement = containerElement
    ...
    NatUI.blockScrollbar = blockScrollbar
    ...
    NatUI.blockScrollbarFrame = blockScrollbarFrame
    ...
    NatUI.blockScrollbarUIListLayout = blockScrollbarUIListLayout
end
...
function NatUI:Section(Title, Icon)
    ...
    sectionFrame.Parent = NatUI.blockScrollbar -- Parent to BlockScrollbar
    NatUI.sectionFrame = sectionFrame
...
function NatUI:Checkbox(Title, Callback)
    ...
    checkboxFrame.Parent = NatUI.blockScrollbar -- Parent to BlockScrollbar
    NatUI.checkboxFrame = checkboxFrame
    ...
    NatUI.checkboxInnerFrame = checkboxInnerFrame
    ...
    NatUI.checkboxUICorner = checkboxUICorner
    ...
    NatUI.checkboxTitleLabel = titleLabel
    ...
    NatUI.checkIconUIStroke = checkIconUIStroke
    ...
    NatUI.toggleCheckLocalScript = toggleCheckLocalScript
end
...
function NatUI:Button(Title, Callback)
    ...
    buttonFrame.BorderColor3 = Color3.fromRGB(0, 0, 0)
    buttonFrame.BackgroundTransparency = 1
    buttonFrame.Parent = NatUI.blockScrollbar -- Parent to BlockScrollbar
    NatUI.buttonFrame = buttonFrame
    ...
    NatUI.buttonTitleLabel = titleLabel
    ...
    NatUI.buttonIconLabel = iconLabel
    ...
    NatUI.clickLocalScript = clickLocalScript
end
...
function NatUI:Paragraph(Title, Desc)
    ...
    paragraphFrame.Parent = NatUI.blockScrollbar -- Parent to BlockScrollbar
    NatUI.paragraphFrame = paragraphFrame
    ...
    NatUI.paragraphInnerFrame = paragraphInnerFrame
    ...
    NatUI.paragraphUICorner = paragraphUICorner
    ...
    NatUI.paragraphTitleLabel = titleLabel
    ...
    NatUI.descriptionLabel = descriptionLabel
end
...
function NatUI:Slider(Title, MaxValue, Callback)
    ...
    sliderFrame.Parent = NatUI.blockScrollbar -- Parent to BlockScrollbar
    NatUI.sliderFrame = sliderFrame
    ...
    NatUI.sliderTitleLabel = titleLabel
    ...
    NatUI.sliderBackground = sliderBackground
    ...
    NatUI.sliderBackgroundUICorner = sliderBackgroundUICorner
    ...
    NatUI.sliderColorUICorner = sliderColorUICorner
    ...
    NatUI.sliderBackgroundLocalScript = sliderBackgroundLocalScript
    ...
    NatUI.triggerButton = triggerButton
    ...
    NatUI.outputValue = outputValue

    -- LocalScript function for Slider
    local function C_52()
        local script = NatUI.sliderBackgroundLocalScript -- Corrected reference
...
nathubUIUICorner.Parent = NatUI.nathubUI
NatUI.nathubUIUICorner = nathubUIUICorner
...
nathubUIUIAspectRatioConstraint.Parent = NatUI.nathubUI
NatUI.nathubUIUIAspectRatioConstraint = nathubUIUIAspectRatioConstraint
...
function NatUI:OpenUI(Title, Icon, BackgroundColor, BorderColor)
    ...
    NatUI.openButtonLocalScript = openButtonLocalScript

    -- LocalScript function for OpenButton drag
    local function C_89()
        local script = NatUI.openButtonLocalScript -- Corrected reference
    ...
    local function C_8c()
        local script = NatUI.iconOpenLocalScript -- Corrected reference
        local Open = script.Parent
        local Open2 = NatUI.openButton -- Reference to the OpenButton frame
        local UI = NatUI.nathubUI -- Reference to NathubUI
    ...
    mainLocalScript.Parent = NatUI.uiLibrary
    NatUI.mainLocalScript = mainLocalScript

    local function C_8d()
        local script = NatUI.mainLocalScript -- Corrected reference
        local ItemContainer = NatUI.buttonFrame -- Reference to the Button frame inside ScrollingFrame
        local Element = NatUI.element -- Reference to the Element frame
